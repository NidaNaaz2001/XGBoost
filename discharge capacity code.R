...
p <- ggplot(data, aes(x = Date, y = Discharge_Capacity))
p <- p + geom_line()
p <- p + theme_bw() + theme(
...
plot(data_pred_cv,panel.grid.major = element_blank(),
     panel.grid.minor = element_blank(),lwd = 0)+ylim(0,1.5) + theme(legend.position = "none",panel.grid.major = element_blank(),
                                                                       panel.grid.minor = element_blank(),
                                                                       strip.text = element_text(size = 14, face = "bold"),
                                                                       axis.title = element_text(size = 14, face = "bold"),
                                                                       axis.text = element_text(size = 14)
...
plot(data_forecasts)+ylim(0,1.5)

plot(data_forecasts, facet = group ~ .)+ylim(0,1.5)
...
plot(data_combined, data_actual = data_actual, actual_indices = actual_indices)+ylim(0,1.5)+ theme(legend.position = "none",panel.grid.major = element_blank(),
                                                                                                     panel.grid.minor = element_blank(),
                                                                                                     strip.text = element_text(size = 14, face = "bold"),
                                                                                                     axis.title = element_text(size = 14, face = "bold"),
                                                                                                     axis.text = element_text(size = 14)
...
plot(data_combined, data_actual = data_actual, actual_indices = actual_indices,
     facet = group ~ .)+ylim(0,1.5)+ theme(legend.position = "none",panel.grid.major = element_blank(),
                                                                                       panel.grid.minor = element_blank(),
                                                                                       strip.text = element_text(size = 14, face = "bold"),
                                                                                       axis.title = element_text(size = 14, face = "bold"),
                                                                                       axis.text = element_text(size = 14)
