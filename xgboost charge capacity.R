...
p <- ggplot(data, aes(x = Date, y = Charge_Capacity))
p <- p + geom_line()
p <- p + theme_bw() + theme(
...
windows <- forecastML::create_windows(data_train, window_length = 0, include_partial_window = FALSE)
windows
...
plot(data_pred_cv,panel.grid.major = element_blank(),
     panel.grid.minor = element_blank()) +ylim(0,2.2)+theme(legend.position = "none",panel.grid.major = element_blank(),
                                                                       panel.grid.minor = element_blank(),
                                                                       strip.text = element_text(size = 14, face = "bold"),
                                                                       axis.title = element_text(size = 14, face = "bold"),
                                                                       axis.text = element_text(size = 14)
...
plot(data_pred_cv, facet = group ~ model,  windows = 1,panel.grid.major = element_blank(),
     panel.grid.minor = element_blank())+ theme(legend.position = "topright",panel.grid.major = element_blank(),
                                                          panel.grid.minor = element_blank(),
                                                          strip.text = element_text(size = 14, face = "bold"),
                                                          axis.title = element_text(size = 14, face = "bold"),
                                                          axis.text = element_text(size = 14)
...
plot(data_pred_cv, facet = group ~ model, windows = 1,panel.grid.major = element_blank(),
     panel.grid.minor = element_blank())+ theme(legend.position = "none",panel.grid.major = element_blank(),
                                                          panel.grid.minor = element_blank(),
                                                          strip.text = element_text(size = 14, face = "bold"),
                                                          axis.title = element_text(size = 14, face = "bold"),
                                                          axis.text = element_text(size = 14)
...
plot(data_forecasts, facet = group ~ .)
...
data_actual <- data[dates >= as.Date("2015-11-13"), ]
actual_indices <- dates[dates >= as.Date("2015-11-13")]

# Plot all final forecasts plus historical data.
plot(data_combined, data_actual = data_actual, actual_indices = actual_indices)+ theme(legend.position = "none",panel.grid.major = element_blank(),
                                                                                                     panel.grid.minor = element_blank(),
                                                                                                     strip.text = element_text(size = 14, face = "bold"),
                                                                                                     axis.title = element_text(size = 14, face = "bold"),
                                                                                                     axis.text = element_text(size = 14)
...
plot(data_combined, data_actual = data_actual, actual_indices = actual_indices,
     facet = group ~ .)+ theme(legend.position = "none",panel.grid.major = element_blank(),
                                                                                       panel.grid.minor = element_blank(),
                                                                                       strip.text = element_text(size = 14, face = "bold"),
                                                                                       axis.title = element_text(size = 14, face = "bold"),
                                                                                       axis.text = element_text(size = 14)
